...
TextLabel.Text = "Hakari obtained: "
...
task.spawn(function()
    while true do
        local collectionFolder = LocalPlayer:FindFirstChild("PlayerGui"):FindFirstChild("Collection").Main.Base.Space.Unit
        local hakariFound = nil
        if collectionFolder then
            if collectionFolder:FindFirstChild("Hakari") then
                hakariFound = true
            else
                hakariFound = false
            end
        end
        TextLabel.Text = "Hakari obtained: " .. tostring(hakariFound)
        task.wait(1)
    end
end)--]]
